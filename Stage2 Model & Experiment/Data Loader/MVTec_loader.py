...
class MVTecDataset(Dataset):
    def __init__(self, root_path='./data', class_name='bottle', is_train=True,
        ...
        self.mvtec_folder_path = os.path.join(root_path, 'mvtec_data')
    ...
    def download(self):
        ...
        if not os.path.exists(self.mvtec_folder_path):
            tar_file_path = './data/mvtec_data/mvtec_anomaly_detection.tar.xz'
            if not os.path.exists(tar_file_path):
                download_url(URL, './data/mvtec_data/mvtec_anomaly_detection.tar.xz')
            print('unzip downloaded dataset: %s' % tar_file_path)
            tar = tarfile.open('./data/mvtec_data/mvtec_anomaly_detection.tar.xz', 'r:xz')
